...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
       ...
       <table class="table table-condensed table-bordered table-striped" id="tableid">
	      ...
	      <tbody id="tbody">
	          <c:forEach items="${pageInfo.list}" var="item">
		        <tr >
		          <td><input type="radio" name="id" value="${item.stsid}"></td>
 ...
 <script type="text/javascript">
   ...
   function timeSelect(){
    ...
    location.href='${ctx}/StayRegister/select?datemin='+
   ...
   function particulars(){
     ...
     $('input[name="id"]:checked').each(function(){             // 遍历获取input被checked的
  	...
  	if(id!=""){
  	    location.href='${ctx}/StayRegister/selectOne?id='
  ...
  $(".tcdPageCode").createPage({
     pageCount:${pageInfo.pageTotalCount},
     current:${pageInfo.pageIndex},
     backFn:function(p){
	     var datemin=document.getElementById("datemin").value;
	     var datemax=document.getElementById("datemax").value;
	     location.href="${ctx}/StayRegister/list?pageIndex="+p+
