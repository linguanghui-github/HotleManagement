...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container">
    ...
    <form action="${ctx}/updateReceiveTarget" method="post" onsubmit="return verify()">
	      ...
	      <div class="row-fluid">
			  <div class="span5 ">
			      ...
			      <select name="targetTypeID" class="cboone inputone">
			          <option  <c:if test="${pass.targetTypeID==56  }"> selected="selected" </c:if> value="56" >
			          团队
			          </option>
		          </select>
			  </div>
 ...
 <script type="text/javascript">
   ...
   function verify(){
    ...
    function deletefunction(){
     parent.document.getElementById('Mainid').src='${ctx}/allreceive.do?xyy=1';
   }
