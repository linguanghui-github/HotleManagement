		...
		<div class="main-container container-fluid">
			...
			<div class="main-content">
				...
				<div style="width:100%;height:100%;">
				  <iframe id="Mainid" src="${ctx}/DateView/tolist.do" style="width:100%;height:100%;"  frameBorder="0" scrolling="no"></iframe>
				</div>
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			function passengerInformation(){
			     ...
			     document.getElementById("smallGuide").innerHTML=s+"";
			     document.getElementById('Mainid').src='${ctx}/allPassenger.do?xyy=1';
			}
			function receiveTarget(){
			     ...
			     document.getElementById("smallGuide").innerHTML=s+"";
			     document.getElementById('Mainid').src='${ctx}/allreceive?xyy=1';
			}
			...
			//alert("hahah")
			     ...
			     document.getElementById("smallGuide").innerHTML=s+"";
			     document.getElementById('Mainid').src='${ctx}/room/roomSet.do';
			}
			...
			function reservations(){
			     ...
			     document.getElementById("smallGuide").innerHTML=s+"";
			     document.getElementById('Mainid').src='${ctx}/Predetermine/tolist.do?state=66';
			}
			function personage(){
			     var a=document.getElementById("stayManageId").getElementsByTagName('span')[0].innerHTML;
			     document.getElementById("bigGuide").innerHTML=a+"";
			...
			function financeStatistics(){
			     ...
			     document.getElementById("smallGuide").innerHTML=s+"";
			     document.getElementById('Mainid').src='${ctx}/StayRegister/listC';
			}
