			  ...
			  <div class="span5 ">
			      ...
			      <select name="commodityTypeID" class="cboone inputone">
		            <c:forEach items="${listTwo}" var="item">
			          <option value="${item.id}" <c:if test="${item.id==listPo.commodityTypeID}" >selected="selected"</c:if>>
			  ...
			  <div class="span5">
			      ...
			      <select name="uOMID" class="cboone inputone">
		            <c:forEach items="${listOne}" var="item">
			          <option value="${item.id}" <c:if test="${item.id==listPo.uOMID}">selected="selected"</c:if>>
			            ${item.attributeDetailsName}
			          </option>
			        </c:forEach> 
		          </select>
