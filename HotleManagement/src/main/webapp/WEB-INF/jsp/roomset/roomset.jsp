...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;">
    <div class="span5">
	    <div class="row-fluid">
		    ...
		    <form action="${ctx}/room/roomSet.do" method="post" style="float: left;">
    ...
    <div class="dgvone">
       <table class="table table-condensed table-bordered table-striped" id="tableid">
	      ...
	      <tbody id="tbody">
	        <c:forEach items="${roomSet.list}" var="item">
		        <tr>
 ...
 <script type="text/javascript">
   function addfunction(){
     parent.document.getElementById('Mainid').src='${ctx}/common/check.do?param=addRoom';
   }
   ...
   var chk_value=[];
  	...
  	if(chk_value!=""){
		if(chk_value.toString().indexOf(",")>0){
		   ...
		   parent.document.getElementById("Mainid").src='${ctx}/common/check.do?param=updateRoom&id='+chk_value;
		}
	}else{
	  alert("请选择一条数据进行修改");
	}
   ...
   var chk_value=[];
     ...
     if(flag){
  	  parent.document.getElementById("Mainid").src='${ctx}/room/delete.do?id='+chk_value;
  	}
  	}else{
...
//        dataType:"json",                                       // json 数据类型提交 
   ...
   $(".tcdPageCode").createPage({
     pageCount:${roomSet.pageTotalCount},
     current:${roomSet.pageIndex},
     backFn:function(p){
     var txtname=document.getElementById("txtnameid").value;
     /* alert(p); */
     location.href="${ctx}/room/roomSet.do?pageIndex="+p+"&txtname="+txtname;
     }
   });
