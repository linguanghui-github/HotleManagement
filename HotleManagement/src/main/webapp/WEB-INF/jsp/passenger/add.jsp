...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;">
    ...
    <form action="${ctx}/addassenger" method="post" onsubmit="return verify()">
    <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span3">
...
<!-- 			          <option value="55" >
      ...
      <div class="row-fluid">
		   <div class="span4"  style="margin-top: 10px;margin-bottom: 8px;"> 
		   	 <button class="btn btn-warning" type="button" id="deletefunction" >
 ...
 <script type="text/javascript">
   ...
   var path="/HotelManagement";
     $("#deletefunction").click(function(){
       window.location.href=path+"/allPassenger?xyy=1";
     })
   ...
   console.log(11);
     if(value!=""){
       $.ajax({                                                      
          ...
          url: '${ctx}/selectpasspapers',       //地址 type 带参数
