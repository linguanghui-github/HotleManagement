...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;">
    ...
    <form action="${ctx}/updatepass" method="post" onsubmit="return verify()">
    <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
	    ...
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span3">
		        <label>姓名：</label>
		        <input id="nameId" name="name" type="text" value="${pass.name}"
		     ...
		     <div class="span3">
		        ...
		        <select name="genderID" style="width:100%;height:26px;">
		                 <option <c:if test="${pass.genderID==31  }"> selected="selected" </c:if> value="31" >
			         男
			          </option>
			       <option <c:if test="${pass.genderID==32  }"> selected="selected" </c:if> value="32" >
			         女
			          </option>
		          </select>
		     </div>
		     <div class="span3">
		        <label>出生日期：</label>
		        <input id="birthDateId" name="birthDate" type="text" style="width:100%;height:26px;" placeholder="年-月-日" value="${pass.birthDate}"> 
		     </div>
		     <div class="span3">
		        <label>民族：</label>
		         <select name="nationID" style="width:100%;height:26px;">
		          
		           <option   <c:if test="${pass.nationID==33  }">selected="selected" </c:if> value="33" >
			          汉族
			          </option>
			     <option <c:if test="${pass.nationID==34  }">selected="selected" </c:if> value="34" >
			          苗族
			          </option>
			           <option <c:if test="${pass.nationID==35  }">selected="selected" </c:if> value="35" >
			          壮族
			          </option>
			          <option <c:if test="${pass.nationID==36  }">selected="selected" </c:if> value="36" >
			          其他
			          </option>
		          </select>
		     </div>
	    ...
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span3">
		        <label>发证机关：</label>
		        <input name="licenceIssuingAuthorty" type="text" style="width:100%;height:26px;" value="${pass.licenceIssuingAuthorty}"> 
		     </div>
		     <div class="span3">
		        <label>证件有效期：</label>
		        <input name="papersValidity" type="text" style="width:100%;height:26px;" placeholder="年-月-日 至 年-月-日" value="${pass.papersValidity}"> 
		      </div>
		     <div class="span3">
		        <label>职业：</label>
		        <input name="profession" type="text" style="width:100%;height:26px;" value="${pass.profession}">
		     </div>
		     <div class="span3">
		        <label>文化程度：</label>
		         <select name="educationDegreeID" style="width:100%;height:26px;">
		          <option  <c:if test="${pass.educationDegreeID==41 }"> selected="selected"</c:if> value="41" >
			           小学
			          </option>
			         <option <c:if test="${pass.educationDegreeID==42 }"> selected="selected"</c:if> value="42" >
			           初中
			          </option>
			            <option <c:if test="${pass.educationDegreeID==43 }"> selected="selected"</c:if> value="43" >
			           高中
			          </option>
			          <option <c:if test="${pass.educationDegreeID==44 }"> selected="selected"</c:if> value="44" >
			           大专
			          </option>
			          <option <c:if test="${pass.educationDegreeID==45 }"> selected="selected"</c:if> value="45" >
			          本科
			          </option>
			           <option <c:if test="${pass.educationDegreeID==46 }"> selected="selected"</c:if> value="46" >
			          研究生
			          </option>
			            <option <c:if test="${pass.educationDegreeID==47 }"> selected="selected"</c:if> value="47" >
			         硕士
			          </option>
			          <option <c:if test="${pass.educationDegreeID==48 }"> selected="selected"</c:if> value="48" >
			         博士
			          </option>
			          <option <c:if test="${pass.educationDegreeID==49 }"> selected="selected"</c:if> value="49" >
			        其他
			          </option>
		          </select>
		     </div>
	      ...
	      <div class="row-fluid">
		     <div class="span3">
		        <label>旅客级别：</label>
		         <select name="passengerLevelID" style="width:100%;height:26px;">
			          ...
			          <option <c:if test="${pass.passengerLevelID==52  }"> selected="selected" </c:if> value="52" >
			          首次
			          </option>
			          <option  <c:if test="${pass.passengerLevelID==53  }"> selected="selected" </c:if> value="53" >
			          熟客
			          </option>
			          <option  <c:if test="${pass.passengerLevelID==54  }"> selected="selected" </c:if> value="54" >
			      VIP
			          </option>
			        <%--   <option  <c:if test="${pass.passengerLevelID==55  }"> selected="selected" </c:if> value="55" >
			          散客
			          </option>
			          <option  <c:if test="${pass.passengerLevelID==56  }"> selected="selected" </c:if> value="56" >
			          团队
			          </option> --%>
		          </select>
		     </div>
		     <div class="span3">
		        ...
		        <select id="papersId" name="papersID" style="width:100%;height:26px;">
		           ...
		           <option  <c:if test="${pass.papersID==37  }"> selected="selected" </c:if> value="37" >
			           二代身份证
			          </option>
			           <option <c:if test="${pass.papersID==38  }"> selected="selected" </c:if> value="38" >
			           护照
			          </option>
			         <option <c:if test="${pass.papersID==39  }"> selected="selected" </c:if> value="39" >
			           其他
			          </option>
		          </select>
		     ...
		     <div class="span3">
		        ...
		        <input id="papersNumberId" name="papersNumber" type="text" onblur="YZ(this.value)"
		         style="width:97%;height:26px;float:left;" onchange="onchangeOne()" value="${pass.papersNumber}"> 
		     ...
		     <div class="span3">
		        <label>单位或住址：</label>
		        <input name="unitsOrAddress" type="text" style="width:100%;height:26px;" value="${pass.unitsOrAddress}"> 
		     </div>
		  </div>
	    </div>
	   <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
	      ...
	      <div class="row-fluid">
		     <div class="span3">
		        ...
		        <select name="thingReasonID" style="width:100%;height:26px;">
		         ...
		         <option   <c:if test="${pass.thingReasonID==50  }">selected="selected" </c:if> value="50" >
			          公务出差
			          </option>
			          <option <c:if test="${pass.thingReasonID==51  }">selected="selected" </c:if>  value="51" >
			         个人旅行
			          </option>
		          </select>
		     ...
		     <div class="span3">
		        <label>从何处来：</label>
		       <input name="whereAreFrom" type="text" style="width:100%;height:26px;" value="${pass.whereAreFrom}"> 
		     </div>
		     <div class="span3">
		        <label>到哪里去：</label>
		         <input name="whereToGo" type="text" style="width:100%;height:26px;" value="${pass.whereToGo}"> 
		     </div>
		     <div class="span3">
		        <label>联系电话：</label>
		         <input id="contactPhoneNumberId" name="contactPhoneNumber" type="text" value="${pass.contactPhoneNumber}"
	    ...
	    <div class="span12">
	      ...
	      <input name="remarks" type="text" style="width:100%;height:26px;" value="${pass.remarks}"> 
	    </div>
 ...
 var Name=document.getElementById("papersNumberId").value;
    ...
    function deletefunction(){
     parent.document.getElementById('Mainid').src='${ctx}/allPassenger?xyy=1';
   }
