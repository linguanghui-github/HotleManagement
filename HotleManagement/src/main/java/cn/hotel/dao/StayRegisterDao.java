...
public interface StayRegisterDao {
	//数据统计
		public List<StayRegister> selectShuJuTongJi(@Param("min") Timestamp min, @Param("max") Timestamp max);
	...
	/*-------------------------------------FinancialStatistics--------------------------------------------------------*/
	  ...
	  //分页模糊查询 Five
	   ...
	   //分页模糊查询总条数 Five
	    ...
	    List<StayRegisterVO> count(@Param("start") String start, @Param("end") String end);
		List<StayRegisterVO> list(@Param("start") String start, @Param("end") String end, @Param("index") Integer index, @Param("size") Integer size);
		List<StayRegisterVO> fjc(@Param("start") String start, @Param("end") String end);
		List<StayRegisterVO> zsrs(@Param("start") String start, @Param("end") String end);
		List<StayRegisterVO> xfje(@Param("start") String start, @Param("end") String end);
		List<StayRegisterVO> jzje(@Param("start") String start, @Param("end") String end);
		List<StayRegisterVO> selectOne(@Param("stsid") Integer stsid);
