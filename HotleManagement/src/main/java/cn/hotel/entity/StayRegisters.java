 ...
 *
 */
public class StayRegisters implements Serializable {
	...
	private Integer isBillID;//结账�?
	private Date registerTime;//登记时间
	private String stayNumber;//住店天数/小时
	private float sumConst;//总费�?
	private String ChangingRoomNumber;//换房次数
	private float changRoomMoney;//换房�?
	private String remarks;//备注
	private Date payTime;//结账时间
	private Date changRoomTime;//换房间时�?
	private Integer remind;//提醒结账
	
	
	private ConsumptionDetailss consumptionDetails;
	
	
	
	public ConsumptionDetailss getConsumptionDetails() {
		return consumptionDetails;
	}
	public void setConsumptionDetails(ConsumptionDetailss consumptionDetails) {
	...
	public StayRegisters(Integer id, Integer predetermineID,
			...
			Date payTime, Date changRoomTime, Integer remind) {
		super();
		this.id = id;
	...
	public void setRemindInteger(Integer remind) {
		this.remind = remind;
	}
