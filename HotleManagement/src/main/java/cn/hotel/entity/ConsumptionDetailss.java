 ...
 *
 */
public class ConsumptionDetailss implements Serializable {
	...
	public void setCommodity(Commoditys commodity) {
		this.commodity = commodity;
	}
	public static long getSerialversionuid() {
		return serialVersionUID;
	}
	public ConsumptionDetailss(Integer id, Integer stayRegisterID,
